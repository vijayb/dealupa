...
mpq.track("Clicked to external deal site", {
	...
	<div style="margin-top:15px; clear:both; overflow:hidden;">
		...
		<!-- BODY -->
		<div style="float:left; width:688px; overflow:hidden;">
			...
			<!-- LEFT SIDE OF BODY (IMAGE + YELP) -->
			<div style="width:310px; float:left; opacity:0.0" id="single-deal-left">
...
HTML;
	...
	if (isset($deal["Images"])) {
		for ($i = 0; $i < count($deal["Images"]); $i++) {
			...
			$html .= <<<HTML
					<li>
						<img src="{$current_image}" style="width:310px;">
					</li>
HTML;
		}
	}
...
$html .= <<<HTML
	...
	<div style="width:280px; float:left; padding:15px; margin:20px 0px 0px 0px; background-image:url(/images/tile_leather.jpg)">
...
HTML;
	...
	$html .= <<<HTML
		...
		<!-- RIGHT SIDE OF BODY (TEXT) -->
		<div style="width:358px; float:right; line-height:1.5">
			{$deal["text"]}	
		</div>
