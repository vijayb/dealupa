...
if (isset($_GET["deal_url"])) {
  ...
  $sql = "SELECT id, url, affiliate_url, discovered, last_updated, num_updates, dup, dup_id, company_id, title, subtitle, price, value, num_purchased, fb_likes, fb_shares, text, fine_print, expired, upcoming, deadline, expires, name, website, phone FROM Deals777 where $criteria"; //strcmp(url, '".mysql_real_escape_string($_GET["deal_url"])."')=0";
